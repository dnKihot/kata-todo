...
export default class Task extends Component {
  render() {
    const {task, onRemove, handleDone, handleToggleEdit, created, currentTime} = this.props
    const timeAgo = formatDistanceToNow(new Date(created), { addSuffix: true, baseDate: currentTime })
    return (     
            <div className="view">
